...
class _LostitemState extends State<Lostitem> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection('Cases').where(
                        ...
                        padding: EdgeInsets.symmetric(vertical: 8.0),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                // style: ElevatedButton.styleFrom(padding: EdgeInsets.symmetric(horizontal: )),
                                onPressed: (){
        ...
        Container(
          child: Center(
            child: Padding(
             ...
             textAlign: TextAlign.justify,
              style: TextStyle(color: MyColors.primaryColor,fontSize: 22),),
            ),
          ),
        );
      },
